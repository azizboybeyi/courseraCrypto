...
//	private static SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MMM/yyyy:kk:mm:ss Z", Locale.US);
	...
	public static LogEntry parseEntry(String line) {
		...
		// 110.76.104.12 - - [30/Sep/2015:07:47:11 -0400] "GET //favicon.ico
		// HTTP/1.1" 200 3426
		...
		String request = munchTo(sb, "\" "); // quote-space is intentional: eat
												// both
	...
	public static  Date parseDate(String dateStr) {
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MMM/yyyy:kk:mm:ss Z",
				Locale.US);
